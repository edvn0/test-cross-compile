...
inline constexpr auto invalid_image_index =
...
[[nodiscard]]
constexpr auto default_image_handle(DefaultImage image) noexcept
    -> ImageHandle {
  return ImageHandle{
...
public:
  ...
  [[nodiscard]]
  auto create_image(ImageCreateInfo const &create_info)
      -> std::expected<ImageHandle, ImageStorageError>;

  [[nodiscard]]
  auto destroy_image(ImageHandle handle)
