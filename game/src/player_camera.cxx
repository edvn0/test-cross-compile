...
PlayerCamera::PlayerCamera(PlayerCameraCreateInfo const &create_info) noexcept :
    ...
    far_clip_(create_info.far_clip) {}
...
auto PlayerCamera::update(glm::vec3 const &capsule_position, float yaw_degrees, float pitch_degrees, float speed_factor,
    ...
    auto const target_position =
            capsule_position - (flat_forward * follow_distance_) + glm::vec3{0.0F, follow_height_ + bob_offset, 0.0F};
    ...
    if (!initialized_) {
        ...
        position_ = glm::mix(position_, target_position, t);
    }
}
